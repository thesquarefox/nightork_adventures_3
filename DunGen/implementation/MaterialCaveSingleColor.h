...
namespace DunGen
{
	...
	public:
		...
		{
			CaveHalfColor = irr::core::vector3df(0.5f*color_.r,0.5f*color_.g,0.5f*color_.b);
		}

		/// get cave color
		irr::video::SColorf GetColor()
		{
			return irr::video::SColorf(2.0f*CaveHalfColor.X,2.0f*CaveHalfColor.Y,2.0f*CaveHalfColor.Z,1.0f);
		}
			...
			irr::s32 userData_)
		{
			...
			services_->setPixelShaderConstant("mHalfColor",	reinterpret_cast<irr::f32*>(&CaveHalfColor), 3);
	...
	private:
		...
		irr::core::vector3df CaveHalfColor;		///< the half color (0.5 * color)
	};
