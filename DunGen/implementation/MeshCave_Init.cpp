...
unsigned int DunGen::CMeshCave::GetWarpRandomSeed() const
{
	return RandomSeed;
}
...
double DunGen::CMeshCave::GetWarpStrength() const
{
	return WarpStrength;
}
...
bool DunGen::CMeshCave::GetWarpOption() const
{
	return WarpEnabled;
}
...
bool DunGen::CMeshCave::GetSmoothOption() const
{
...
DunGen::ENormalWeightMethod::Enum DunGen::CMeshCave::GetNormalWeightMethod() const
{
	return NormalWeightMethod;
}
